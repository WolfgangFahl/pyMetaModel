...
"""
        ...
        for linkKey in links.keys():
            ...
            source = link["source"]
            target = link["target"]
            self.uml += f"{source} \"{sourceRole} {sourceMany}\" -- \"{targetRole} {targetMany}\" {target}\n"
