...
# Generation date: 2023-03-05T16:29:11
# Schema: MetaModel
#
# id: MetaModel
# description:
...
class Context(YAMLRoot):
    ...
    master: Optional[Union[str, URI]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.master is not None and not isinstance(self.master, URI):
            self.master = URI(self.master)
...
class Property(YAMLRoot):
    ...
    sortPos: Optional[float] = None
    primaryKey: Optional[Union[bool, Bool]] = None
    mandatory: Optional[Union[bool, Bool]] = None
    namespace: Optional[str] = None
    size: Optional[float] = None
    uploadable: Optional[Union[bool, Bool]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.index is not None and not isinstance(self.index, float):
            self.index = float(self.index)

        if self.sortPos is not None and not isinstance(self.sortPos, float):
            self.sortPos = float(self.sortPos)

        if self.primaryKey is not None and not isinstance(self.primaryKey, Bool):
            self.primaryKey = Bool(self.primaryKey)
        ...
        if self.uploadable is not None and not isinstance(self.uploadable, Bool):
            self.uploadable = Bool(self.uploadable)
        ...
        if self.showInGrid is not None and not isinstance(self.showInGrid, Bool):
            self.showInGrid = Bool(self.showInGrid)

        if self.isLink is not None and not isinstance(self.isLink, Bool):
            self.isLink = Bool(self.isLink)
...
class SMWType(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.helppage is not None and not isinstance(self.helppage, URI):
            self.helppage = URI(self.helppage)
...
class Topic(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.listLimit is not None and not isinstance(self.listLimit, float):
            self.listLimit = float(self.listLimit)

        if self.cargo is not None and not isinstance(self.cargo, Bool):
            self.cargo = Bool(self.cargo)
...
class Action(YAMLRoot):
    ...
    service: Optional[Union[str, URI]] = None
    inputtype: Optional[str] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.service is not None and not isinstance(self.service, URI):
            self.service = URI(self.service)
...
class TopicLink(YAMLRoot):
    ...
    sourceMultiple: Optional[Union[bool, Bool]] = None
    sourceDocumentation: Optional[str] = None
    target: Optional[str] = None
    targetRole: Optional[str] = None
    targetMultiple: Optional[Union[bool, Bool]] = None
    targetDocumentation: Optional[str] = None
    masterDetail: Optional[Union[bool, Bool]] = None
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if self.sourceMultiple is not None and not isinstance(self.sourceMultiple, Bool):
            self.sourceMultiple = Bool(self.sourceMultiple)
        ...
        if self.targetMultiple is not None and not isinstance(self.targetMultiple, Bool):
            self.targetMultiple = Bool(self.targetMultiple)
        ...
        if self.masterDetail is not None and not isinstance(self.masterDetail, Bool):
            self.masterDetail = Bool(self.masterDetail)
...
slots.since = Slot(uri=METAMODEL.since, name="since", curie=METAMODEL.curie('since'),
                   model_uri=METAMODEL.since, domain=None, range=Optional[Union[str, XSDDate]])

slots.updated = Slot(uri=METAMODEL.updated, name="updated", curie=METAMODEL.curie('updated'),
                   model_uri=METAMODEL.updated, domain=None, range=Optional[Union[str, XSDDate]])
...
slots.master = Slot(uri=METAMODEL.master, name="master", curie=METAMODEL.curie('master'),
                   model_uri=METAMODEL.master, domain=None, range=Optional[Union[str, URI]])
...
slots.size = Slot(uri=METAMODEL.size, name="size", curie=METAMODEL.curie('size'),
                   model_uri=METAMODEL.size, domain=None, range=Optional[float])

slots.uploadable = Slot(uri=METAMODEL.uploadable, name="uploadable", curie=METAMODEL.curie('uploadable'),
                   model_uri=METAMODEL.uploadable, domain=None, range=Optional[Union[bool, Bool]])
...
slots.showInGrid = Slot(uri=METAMODEL.showInGrid, name="showInGrid", curie=METAMODEL.curie('showInGrid'),
                   model_uri=METAMODEL.showInGrid, domain=None, range=Optional[Union[bool, Bool]])

slots.isLink = Slot(uri=METAMODEL.isLink, name="isLink", curie=METAMODEL.curie('isLink'),
                   model_uri=METAMODEL.isLink, domain=None, range=Optional[Union[bool, Bool]])
...
slots.helppage = Slot(uri=METAMODEL.helppage, name="helppage", curie=METAMODEL.curie('helppage'),
                   model_uri=METAMODEL.helppage, domain=None, range=Optional[Union[str, URI]])
...
slots.listLimit = Slot(uri=METAMODEL.listLimit, name="listLimit", curie=METAMODEL.curie('listLimit'),
                   model_uri=METAMODEL.listLimit, domain=None, range=Optional[float])

slots.cargo = Slot(uri=METAMODEL.cargo, name="cargo", curie=METAMODEL.curie('cargo'),
                   model_uri=METAMODEL.cargo, domain=None, range=Optional[Union[bool, Bool]])
...
slots.service = Slot(uri=METAMODEL.service, name="service", curie=METAMODEL.curie('service'),
                   model_uri=METAMODEL.service, domain=None, range=Optional[Union[str, URI]])
...
slots.sourceMultiple = Slot(uri=METAMODEL.sourceMultiple, name="sourceMultiple", curie=METAMODEL.curie('sourceMultiple'),
                   model_uri=METAMODEL.sourceMultiple, domain=None, range=Optional[Union[bool, Bool]])
...
slots.targetMultiple = Slot(uri=METAMODEL.targetMultiple, name="targetMultiple", curie=METAMODEL.curie('targetMultiple'),
                   model_uri=METAMODEL.targetMultiple, domain=None, range=Optional[Union[bool, Bool]])
...
slots.masterDetail = Slot(uri=METAMODEL.masterDetail, name="masterDetail", curie=METAMODEL.curie('masterDetail'),
                   model_uri=METAMODEL.masterDetail, domain=None, range=Optional[Union[bool, Bool]])
...
slots.context__since = Slot(uri=METAMODEL.since, name="context__since", curie=METAMODEL.curie('since'),
                   model_uri=METAMODEL.context__since, domain=None, range=Optional[Union[str, XSDDate]])

slots.context__updated = Slot(uri=METAMODEL.updated, name="context__updated", curie=METAMODEL.curie('updated'),
                   model_uri=METAMODEL.context__updated, domain=None, range=Optional[Union[str, XSDDate]])
...
slots.context__master = Slot(uri=METAMODEL.master, name="context__master", curie=METAMODEL.curie('master'),
                   model_uri=METAMODEL.context__master, domain=None, range=Optional[Union[str, URI]])
...
slots.property__size = Slot(uri=METAMODEL.size, name="property__size", curie=METAMODEL.curie('size'),
                   model_uri=METAMODEL.property__size, domain=None, range=Optional[float])

slots.property__uploadable = Slot(uri=METAMODEL.uploadable, name="property__uploadable", curie=METAMODEL.curie('uploadable'),
                   model_uri=METAMODEL.property__uploadable, domain=None, range=Optional[Union[bool, Bool]])
...
slots.property__showInGrid = Slot(uri=METAMODEL.showInGrid, name="property__showInGrid", curie=METAMODEL.curie('showInGrid'),
                   model_uri=METAMODEL.property__showInGrid, domain=None, range=Optional[Union[bool, Bool]])

slots.property__isLink = Slot(uri=METAMODEL.isLink, name="property__isLink", curie=METAMODEL.curie('isLink'),
                   model_uri=METAMODEL.property__isLink, domain=None, range=Optional[Union[bool, Bool]])
...
slots.sMWType__helppage = Slot(uri=METAMODEL.helppage, name="sMWType__helppage", curie=METAMODEL.curie('helppage'),
                   model_uri=METAMODEL.sMWType__helppage, domain=None, range=Optional[Union[str, URI]])
...
slots.topic__listLimit = Slot(uri=METAMODEL.listLimit, name="topic__listLimit", curie=METAMODEL.curie('listLimit'),
                   model_uri=METAMODEL.topic__listLimit, domain=None, range=Optional[float])

slots.topic__cargo = Slot(uri=METAMODEL.cargo, name="topic__cargo", curie=METAMODEL.curie('cargo'),
                   model_uri=METAMODEL.topic__cargo, domain=None, range=Optional[Union[bool, Bool]])
...
slots.action__service = Slot(uri=METAMODEL.service, name="action__service", curie=METAMODEL.curie('service'),
                   model_uri=METAMODEL.action__service, domain=None, range=Optional[Union[str, URI]])
...
slots.action__since = Slot(uri=METAMODEL.since, name="action__since", curie=METAMODEL.curie('since'),
                   model_uri=METAMODEL.action__since, domain=None, range=Optional[Union[str, XSDDate]])
...
slots.topicLink__sourceMultiple = Slot(uri=METAMODEL.sourceMultiple, name="topicLink__sourceMultiple", curie=METAMODEL.curie('sourceMultiple'),
                   model_uri=METAMODEL.topicLink__sourceMultiple, domain=None, range=Optional[Union[bool, Bool]])
...
slots.topicLink__targetMultiple = Slot(uri=METAMODEL.targetMultiple, name="topicLink__targetMultiple", curie=METAMODEL.curie('targetMultiple'),
                   model_uri=METAMODEL.topicLink__targetMultiple, domain=None, range=Optional[Union[bool, Bool]])
...
slots.topicLink__masterDetail = Slot(uri=METAMODEL.masterDetail, name="topicLink__masterDetail", curie=METAMODEL.curie('masterDetail'),
                   model_uri=METAMODEL.topicLink__masterDetail, domain=None, range=Optional[Union[bool, Bool]])
